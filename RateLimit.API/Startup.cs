...
namespace RateLimit.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.Configure<IpRateLimitPolicies>(Configuration
            //   .GetSection("IpRateLimitPolicies"));

            //services.AddSingleton<IIpPolicyStore, MemoryCacheIpPolicyStore>();

            services.Configure<ClientRateLimitOptions>(Configuration
              .GetSection("ClientRateLimiting"));

            services.Configure<ClientRateLimitPolicies>(Configuration
